...
<html lang="en">
  ...
  <body>
    ...
    <div class="main-container">
      ...
      <h4>Companies with 2nd highest budget</h4>
      <?php
        // condition
        if(true) {
          ...
          // SQL query
          $sql = "SELECT * FROM company WHERE budget = (SELECT max(budget) FROM company WHERE budget < (SELECT max(budget) FROM company));";
