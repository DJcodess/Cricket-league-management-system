  ...
  <body>
    ...
    <div class="main-container">
      ...
      <div class="container mt-3">
        <h4>Coaches coaching a particular team</h4>
        <form action="/dbmsproj/dir/q7.php" method="post">
      ...
      <?php
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST') {
          ...
          // SQL query
          $sql = "SELECT * FROM coach INNER JOIN team ON coach.team_name=team.team_name WHERE team.team_name='$team_name';";
